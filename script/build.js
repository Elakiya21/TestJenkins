...
function build(previousSizeMap) {
  ...
  console.log("\n\n")
  console.log("Build started at: ", Date())
  console.log("\n\n")
  webpack(config).run((err, stats) => {
    ...
    if (stats.hasErrors()) {
      printErrors("Failed to compile.", stats.toJson().errors)
      process.exit(1)
    }
    ...
    if (process.env.CI && stats.compilation && stats.compilation.warnings && stats.compilation.warnings.length) {
